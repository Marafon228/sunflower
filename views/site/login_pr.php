    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h2 class="banner-title">Авторизация/Регистрация автора</h2>
                <div class="bread-crumb"><a href="index.html">Главная</a> / Авторизация</div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <h3 class="sec-title">Авторизация</h3>
            ...
            <div class="col-lg-6 col-md-6">
                <h3 class="sec-title">Регистрация нового аккаунта</h3>
